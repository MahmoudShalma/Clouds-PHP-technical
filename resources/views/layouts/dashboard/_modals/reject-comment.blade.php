<div class="modal fade" id="reject_comment_modal" tabindex="-1" role="dialog" aria-labelledby="rejectModalLabel"
     aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="" id="reject-comment-form" method="get" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{--                {{ method_field('DELETE') }}--}}
