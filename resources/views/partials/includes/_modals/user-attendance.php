<div class="modal fade" id="user_attendance_modal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
     aria-hidden="true" data-backdrop="static" data-keyboard="false">

    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="" id="user-attendance-form" method="get" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{--                {{ method_field('DELETE') }}--}}
